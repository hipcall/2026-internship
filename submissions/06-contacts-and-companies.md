...
Bir kişiyi firmaya bağlamak için kişinin `company_id` alanına ilgili firmanın dahili Hipcall ID'si atanır (`"company_id": 80684`).
...
* **İlk Başlangıçtaki Hipcall Kişi Sayısı:** 21
* **Ekleme & Güncelleme Sonrası Kişi Sayısı:** 25 (Ayşe, Mehmet, Zişan, Kaya başarıyla eklendi, Can ve Mehmet güncellendi)
* **İkinci Çalıştırma Sonrası Kişi Sayısı:** 25 (Yeni kişi: 0, Güncellenen: 0, Değişmeyen: 5, Hata: 1)
